...
public class OrderItemResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_TOTAL_PRIECE = new BigDecimal(0);
    private static final BigDecimal UPDATED_TOTAL_PRIECE = new BigDecimal(1);
    ...
    public static OrderItem createEntity(EntityManager em) {
        OrderItem orderItem = new OrderItem()
            .totalPriece(DEFAULT_TOTAL_PRIECE)
    ...
    public void createOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getTotalPriece()).isEqualTo(DEFAULT_TOTAL_PRIECE);
    ...
    @Test
    @Transactional
    public void checkTotalPrieceIsRequired() throws Exception {
        int databaseSizeBeforeTest = orderItemRepository.findAll().size();
        // set the field null
        orderItem.setTotalPriece(null);
    ...
    public void getAllOrderItems() throws Exception {
        ...
        restOrderItemMockMvc.perform(get("/api/order-items?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].totalPriece").value(hasItem(DEFAULT_TOTAL_PRIECE.intValue())))
    ...
    public void getOrderItem() throws Exception {
        ...
        restOrderItemMockMvc.perform(get("/api/order-items/{id}", orderItem.getId()))
            ...
            .andExpect(jsonPath("$.totalPriece").value(DEFAULT_TOTAL_PRIECE.intValue()))
    ...
    public void updateOrderItem() throws Exception {
        ...
        updatedOrderItem
            .totalPriece(UPDATED_TOTAL_PRIECE)
        ...
        OrderItem testOrderItem = orderItemList.get(orderItemList.size() - 1);
        assertThat(testOrderItem.getTotalPriece()).isEqualTo(UPDATED_TOTAL_PRIECE);
